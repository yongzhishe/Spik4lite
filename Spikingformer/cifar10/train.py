...
parser.add_argument('--output', default='spikingformer/cifar10/output/same_acc_test',
                    type=str,
                    metavar='PATH',
...
parser.add_argument('--pruning-interval', type=int, default=70, metavar='N',
...
parser.add_argument('--save-start-epoch', type=int, default=370, metavar='N',
                    help='Epoch to start saving checkpoints (default: 0, save from beginning)')


parser.add_argument('--pe-max-prune-rate', type=float, default=0.3, metavar='VAL',
                    help='Maximum pruning rate per step for Patch Embedding layers (default: 0.4)')
parser.add_argument('--mlp-max-prune-rate', type=float, default=0.5, metavar='VAL',
