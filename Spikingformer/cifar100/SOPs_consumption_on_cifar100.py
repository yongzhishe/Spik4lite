...
parser.add_argument('--output', default='spikingformer/cifar100/output/energy_infer', type=str, metavar='PATH',
...
parser.add_argument('--log-output-dir',
                    default='spikingformer/cifar100/output/energy_infer', type=str,
