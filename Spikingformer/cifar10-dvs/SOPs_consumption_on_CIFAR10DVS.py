...
def parse_args():
    ...
    parser.add_argument('--output-dir', default='spikingformer/CIFAR10DVS/output/test', help='path where to save')
...
def main(args):
    ...
    # using real data
    Nops, Nparams = get_model_complexity_info(model, (3, 224, 224), data_loader_test, as_strings=True,
