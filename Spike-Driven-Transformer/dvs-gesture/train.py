...
from module.Spik4lite import EnergyPenaltyTerm, GumbelTemperatureScheduler, SpikingConv2d
import gc
...
def parse_args():
    ...
    parser.add_argument('--output-dir', default='spike-driven-transformer/DVS128Gesture/output/hyper_finetune', help='path where to save')
    ...
    parser.add_argument('--pe-max-prune-rate', type=float, default=0.1,
                        help='Maximum pruning rate for Patch Embedding (default: 0.05)')
    parser.add_argument('--mlp-max-prune-rate', type=float, default=0.2,
...
def train_one_epoch(model, criterion, optimizer, data_loader, device, epoch, 
                    print_freq, scaler=None, T_train=None, aug=None, trival_aug=None, mixup_fn=None, regularizer_fn=None, temp_scheduler=None):
    model.train()
