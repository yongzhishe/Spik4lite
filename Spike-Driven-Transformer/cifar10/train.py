...
parser.add_argument(
    "--output",
    default="spike-driven-transformer/cifar10/output/train",
    type=str,
    metavar="PATH",
...
parser.add_argument('--pruning-end-offset', type=int, default=20, metavar='N',
                    help='Stop pruning this many epochs before the end (fine-tuning phase, default: 20)')

parser.add_argument('--save-start-epoch', type=int, default=285, metavar='N',
