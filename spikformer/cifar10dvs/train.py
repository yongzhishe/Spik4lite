...
def parse_args():
    ...
    parser.add_argument('--output-dir', default='spikformer/CIFAR10DVS/output/train', help='path where to save')
    ...
    parser.add_argument('--lambda-energy', type=float, default=0.005,
    ...
    parser.add_argument('--pruning-interval', type=int, default=40, metavar='N',
    ...
    parser.add_argument('--pe-max-prune-rate', type=float, default=0.05,
                    help='Maximum pruning rate for Patch Embedding (default: 0.05)')
    parser.add_argument('--mlp-max-prune-rate', type=float, default=0.15,
