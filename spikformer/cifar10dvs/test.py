...
def clean_and_set_inference_mode(model):
    ...
    print(f"Removed gating layers from {removed_count} (SpikingConv2d, SpikingConv1d) modules.")
...
def parse_args():
    ...
    parser.add_argument('--output-dir', default='spikformer/CIFAR10DVS/output/test', help='path where to save')
    parser.add_argument('--resume', default='checkpoint_max_test_acc1.pth', 
                        help='resume from checkpoint')
    parser.add_argument("--sync-bn", dest="sync_bn", help="Use sync batch norm", action="store_true")
    parser.add_argument("--test-only", dest="test_only", default=True, help="Only test the model", action="store_true")

    parser.add_argument('--amp', default=True, action='store_true', help='Use AMP training')
    parser.add_argument('--world-size', default=1, type=int, help='number of distributed processes')
    parser.add_argument('--dist-url', default='env://', help='url used to set up distributed training')
    parser.add_argument('--tb', default=False,  action='store_true', help='Use TensorBoard to record logs')
    ...
    parser.add_argument('--epochs', type=int, default=96, metavar='N', help='number of epochs to train (default: 2)')
    ...
    parser.add_argument('--mixup-prob', type=float, default=0.5, help='Probability of performing mixup or cutmix when either/both is enabled')
...
def evaluate(model, criterion, data_loader, device, print_freq=100, header='Test:'):
    ...
    avg_batch_time = metric_logger.batch_time.global_avg
...
def main(args):
    ...
    if utils.is_main_process():
        ...
        _logger.info(f"Logging results to {log_file}")
