...
import gc
from Spik4lite import SpikingConv2d, SpikingConv1d
...
parser.add_argument('--resume',
                    default='checkpoint-404.pth.tar',
...
parser.add_argument('--output', default='spikformer/cifar100/output/test', type=str, metavar='PATH',
...
def clean_and_set_inference_mode(model):
    ...
    _logger.info(f"Removed gating layers from {removed_count} (SpikingConv2d, SpikingConv1d) modules.")
...
def validate(model, loader, loss_fn, args, amp_autocast=suppress, log_suffix=''):
    ...
    metrics = OrderedDict([('time', batch_time_m.avg), ('loss', losses_m.avg), ('top1', top1_m.avg), ('top5', top5_m.avg)])
