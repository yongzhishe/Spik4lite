...
parser.add_argument('--output', default='spikformer/cifar100/output/train', type=str, metavar='PATH',
...
parser.add_argument('--pruning-interval', type=int, default=50, metavar='N',
...
parser.add_argument('--mlp-max-prune-rate', type=float, default=0.5,
    ...
    try:
        for epoch in range(start_epoch, num_epochs):
            ...
            if epoch < args.pruning_start_epoch:
                ...
                if args.local_rank == 0 and epoch == start_epoch:
                    _logger.info(f"WARMUP: Regularization Disabled until epoch {args.pruning_start_epoch}")
            
            elif epoch >= fine_tuning_start_epoch:
                current_regularizer = None
