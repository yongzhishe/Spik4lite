...
def parse_args():
    ...
    parser.add_argument('--output-dir', default='spikformer/DVS128Gesture/output/train', help='path where to save')
    ...
    parser.add_argument('--mlp-max-prune-rate', type=float, default=0.25,
